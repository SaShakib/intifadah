...
<div className="space-y-5 text-sm leading-6 text-fg-2">
          ...
          <p className="rounded-xl bg-success-bg/60 px-3 py-2 text-xs font-semibold text-success">বইঘরে একই নামের বই আগে থেকেই থাকলে এটিও যোগ করা যাবে — এটি নতুন <strong>কপি</strong> হিসেবে যুক্ত হবে এবং বইয়ের কপি সংখ্যা বাড়বে। মূল্য, কপির নোট (বর্ণনা) ইত্যাদি আলাদা রাখা যায়।</p>
