...
export const ADMIN_NAV_ITEMS: NavItem[] = [
  ...
  { href: '/admin/books-featured', label: 'শীর্ষ রেটেড বই', icon: 'star', section: 'প্রধান মেনু', superAdminOnly: true },
...
export const USER_NAV_ITEMS: NavItem[] = [
  ...
  { href: '/books/plans', label: 'প্ল্যান', icon: 'book-open-check', section: 'প্রধান মেনু' },
